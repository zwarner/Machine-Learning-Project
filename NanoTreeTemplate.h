...
// Sun Mar 15 18:48:35 2020 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: 0E66BC8C-8AA4-F546-807B-0944E02F1DC0.root
//////////////////////////////////////////////////////////

#ifndef NanoTreeTemplate_h
#define NanoTreeTemplate_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   NanoTreeTemplate(TTree *tree=0);
   virtual ~NanoTreeTemplate();
...
#ifdef NanoTreeTemplate_cxx
NanoTreeTemplate::NanoTreeTemplate(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("0E66BC8C-8AA4-F546-807B-0944E02F1DC0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("0E66BC8C-8AA4-F546-807B-0944E02F1DC0.root");
      }
...
NanoTreeTemplate::~NanoTreeTemplate()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NanoTreeTemplate::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoTreeTemplate::LoadTree(Long64_t entry)
{
...
void NanoTreeTemplate::Init(TTree *tree)
{
...
Bool_t NanoTreeTemplate::Notify()
{
...
void NanoTreeTemplate::Show(Long64_t entry)
{
...
Int_t NanoTreeTemplate::Cut(Long64_t entry)
{
...
#endif // #ifdef NanoTreeTemplate_cxx
