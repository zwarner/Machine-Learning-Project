...
jetSequence = cms.Sequence(jetCorrFactorsNano+updatedJets+tightJetId+tightJetIdLepVeto+bJetVars+jercVars+qgtagger+updatedJetsWithUserData+finalJets)



#jetSequence = cms.Sequence(jetCorrFactorsNano+updatedJets+tightJetId+tightJetIdLepVeto+bJetVars+updatedJetsWithUserData+finalJets)
...
jetTables = cms.Sequence(bjetMVA+bjetNN+jetTable)
